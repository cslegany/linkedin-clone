...
import { CloseRounded, CommentOutlined, MoreHorizRounded, ThumbUpOffAltRounded, ThumbUpOffAltOutlined, DeleteRounded, ReplyRounded } from "@mui/icons-material";
...
import { IPost, ModalType_gifYouUp } from "../model/Model";
    ...
    >
      ...
      {post.photoUrl && !modalPost && (
        <img src={post.photoUrl} alt="" className="w-full cursor-pointer"
          onClick={() => {
            setModalOpen(true);
            setModalType(ModalType_gifYouUp);
            setPostState(post);
          }}
        />
      )}
